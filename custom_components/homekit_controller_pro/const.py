"""Constants for the homekit_controller_pro component (fork of HA core's homekit_controller)."""
...
HOMEKIT_ACCESSORY_DISPATCH = {
    ...
    ServicesTypes.IRRIGATION_SYSTEM: "switch",
...
CHARACTERISTIC_PLATFORMS = {
    ...
    CharacteristicsTypes.VENDOR_ECOBEE_EQUIPMENT_RUNNING: "sensor",
    CharacteristicsTypes.VENDOR_ECOBEE_STATUS_CODE: "sensor",
    CharacteristicsTypes.VENDOR_ECOBEE_AUX_HEAT_ACTIVE: "binary_sensor",
